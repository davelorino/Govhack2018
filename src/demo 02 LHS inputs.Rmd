...
renderValueBox({
    #Income box
    valueBox(
        prettyNum( paste( "$", round(input$income/1000, 0), " k  p.a."), big.mark = ","),
        icon = "fa-user"
        )
})
```
...
renderValueBox({
    #Maximum rent box
    valueBox(
        prettyNum( paste("$", round(input$income * 0.3 / 1000, 0), "k  p.a."), big.mark = ",")
        , icon = "fa-map-marker"
        ) 
})
```
...
renderValueBox({
    #Maximum rent box
    valueBox(
        prettyNum( paste("$", round(input$income * 0.3 / 52, 0), " per week"), big.mark = ",")
        , icon = "fa-map-marker"
        ) 
})
```
