...
#List the cities, and allow the user to choose them from a drop down (selectInput)
    all_sector <- income_by_job2$sector
...
renderLeaflet({
    ...
    #Define areas using geojson
        ...
        good <- geojson_json(good2)
        small_problem <- geojson_json(small_problem2)
        big_problem <- geojson_json(big_problem2)
        no_way <- geojson_json(no_way2)
